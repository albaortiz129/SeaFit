    ...
    <div class="inicio-contenedor">
        ...
        <section class="inicio-servicios-grid px-4 py-16 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div
                ...
                <h3 class="text-gray-900 text-xl font-bold mb-4">Entrenador Personal</h3>
                <p class="text-gray-600 text-base leading-relaxed mb-6">
                    Maximiza tus resultados con un plan 100% a tu medida. Agenda, reprograma y confirma tus sesiones
                    directamente con tu entrenador a través de nuestra plataforma web.
                </p>
                <a href="{{ url('/servicios') }}" class="text-[#1A3878] font-bold flex items-center gap-2 hover:underline">
